...
//   const handleToggleContent = (blogId: string) => {
//     if (expandedContentId === blogId) {
//       setExpandedContentId(null);
//     } else {
//       setExpandedContentId(blogId);
//     }
//   };
...
//                 <th className="border border-gray-300 ">rating</th>
//                 <th className="border border-gray-300 ">review</th>
//                 <th className="border border-gray-300 ">content</th>{" "}
...
//                   {/* Render content */}
//                   <td className="border border-gray-300 px-2">
//                     {expandedContentId === item._id ? (
//                       <div>{item.content}</div>
//                     ) : (
//                       <button
//                         onClick={() => handleToggleContent(item._id)}
