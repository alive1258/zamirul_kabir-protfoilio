...
export const experiencesData: Experience[] = [
  ...
  },
  {
    id: 4,
    title: "Frontend Developer",
    company: "Coremindsoft",
    location: "Sirajganj District, Rajshahi, Bangladesh · Remote",
    date: "Apr 2025 - Sep 2025",
    duration: "6 months",
    description:
      "At CoreMindSoft, I work as a Frontend Developer focusing on building and maintaining modern web applications using React.js, Next.js, and NestJS.",
    achievements: [
      "Developing modern, reusable UI components using React.js and Next.js",
      "Designing and implementing custom themes and admin dashboards for SaaS and internal tools",
      "Collaborating with the backend team to integrate APIs built with NestJS",
      "Creating responsive layouts using Tailwind CSS and ensuring cross-browser compatibility",
      "Working on dynamic theming, user roles, and permission-based dashboards",
      "Implementing performance optimizations, SSR, and SEO best practices",
      "Participating in code reviews, Git-based collaboration, and Agile development workflows",
    ],
    technologies: [
      "React.js",
      "Next.js 14",
